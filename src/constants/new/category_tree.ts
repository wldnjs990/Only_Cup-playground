      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 3, label: '패션프루트', value: 'aroma_fruity_tropical_passionfruit' },
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 2, label: '동방미인', value: 'aroma_tea_oolong_oriental_beauty' },
      ...
      children: [
        {
          ...
          label: '오키드',
          children: [
            { id: 1, label: '화이트오키드', value: 'aroma_orchid_violet_orchid_white' },
            { id: 2, label: '바닐라오키드', value: 'aroma_orchid_violet_orchid_vanilla' },
            { id: 3, label: '핑크오키드', value: 'aroma_orchid_violet_orchid_pink' },
            { id: 4, label: '덴드로비움', value: 'aroma_orchid_violet_orchid_dendrobium' },
            { id: 5, label: '카틀레야', value: 'aroma_orchid_violet_orchid_cattleya' },
          ],
        },
        {
          id: 2,
          label: '바이올렛',
          children: [
            { id: 1, label: '스위트바이올렛', value: 'aroma_orchid_violet_violet_sweet' },
            { id: 2, label: '아이오니아', value: 'aroma_orchid_violet_violet_ionone' },
            { id: 3, label: '바이올렛리프', value: 'aroma_orchid_violet_violet_leaf' },
            { id: 4, label: '바이올렛캔디', value: 'aroma_orchid_violet_violet_candy' },
            { id: 5, label: '바이올렛파우더', value: 'aroma_orchid_violet_violet_powder' },
          ],
        },
        {
          id: 3,
          label: '피오니',
          children: [
            { id: 1, label: '코랄피오니', value: 'aroma_orchid_violet_peony_coral' },
            { id: 2, label: '핑크피오니', value: 'aroma_orchid_violet_peony_pink' },
            { id: 3, label: '화이트피오니', value: 'aroma_orchid_violet_peony_white' },
            { id: 4, label: '트리피오니', value: 'aroma_orchid_violet_peony_tree' },
            { id: 5, label: '프레시피오니', value: 'aroma_orchid_violet_peony_fresh' },
          ],
        },
        {
          id: 4,
          ...
          children: [
            ...
            { id: 5, label: '만개매화', value: 'aroma_orchid_violet_plum_full_bloom' },
          ],
        },
        {
          id: 5,
          label: '수선화',
          children: [
            { id: 1, label: '나르시수스', value: 'aroma_orchid_violet_narcissus_narcissus' },
            { id: 2, label: '화이트수선화', value: 'aroma_orchid_violet_narcissus_white' },
            { id: 3, label: '옐로우수선화', value: 'aroma_orchid_violet_narcissus_yellow' },
            { id: 4, label: '더블수선화', value: 'aroma_orchid_violet_narcissus_double' },
            { id: 5, label: '페이퍼화이트', value: 'aroma_orchid_violet_narcissus_paperwhite' },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          label: '코코아·커피',
          children: [
            { id: 1, label: '코코아닙', value: 'taste_bitterness_cocoa_coffee_cocoa_nib' },
            { id: 2, label: '다크초콜릿', value: 'taste_bitterness_cocoa_coffee_dark_chocolate' },
            { id: 3, label: '에스프레소', value: 'taste_bitterness_cocoa_coffee_espresso' },
            { id: 4, label: '카카오허스크', value: 'taste_bitterness_cocoa_coffee_cacao_husk' },
            {
              id: 5,
              label: '베이킹초콜릿',
        ...
        },
        {
          ...
          label: '허벌·식물성',
          children: [
            { id: 1, label: '겐티안', value: 'taste_bitterness_herbal_bitter_gentian' },
            { id: 2, label: '웜우드', value: 'taste_bitterness_herbal_bitter_wormwood' },
            { id: 3, label: '민들레뿌리', value: 'taste_bitterness_herbal_bitter_dandelion_root' },
            { id: 4, label: '치커리', value: 'taste_bitterness_herbal_bitter_chicory' },
            { id: 5, label: '말차', value: 'taste_bitterness_herbal_bitter_matcha' },
          ],
        },
        {
          id: 3,
          label: '로스티드',
          children: [
            { id: 1, label: '차콜', value: 'taste_bitterness_roasted_bitter_char' },
            { id: 2, label: '탄 토스트', value: 'taste_bitterness_roasted_bitter_burnt_toast' },
            { id: 3, label: '스모크', value: 'taste_bitterness_roasted_bitter_smoke' },
        ...
        },
        {
          ...
          label: '타닌',
          children: [
            { id: 1, label: '블랙티', value: 'taste_bitterness_tannin_black_tea_tannin' },
            { id: 2, label: '레드와인타닌', value: 'taste_bitterness_tannin_red_wine_tannin' },
            { id: 3, label: '호두껍질', value: 'taste_bitterness_tannin_walnut_skin' },
            { id: 4, label: '포도씨', value: 'taste_bitterness_tannin_grape_seed' },
        ...
        },
        {
          ...
          label: '퀴닌·홉',
          children: [
            { id: 1, label: '토닉워터', value: 'taste_bitterness_quinine_hops_tonic' },
            { id: 2, label: '자몽피스', value: 'taste_bitterness_quinine_hops_grapefruit_pith' },
            { id: 3, label: '홉', value: 'taste_bitterness_quinine_hops_hops' },
            { id: 4, label: '퀴닌', value: 'taste_bitterness_quinine_hops_quinine' },
            { id: 5, label: '콜라넛', value: 'taste_bitterness_quinine_hops_kola_nut' },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          label: '미네랄',
          children: [
            { id: 1, label: '미네랄워터', value: 'taste_saltiness_mineral_mineral_water' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 4, label: '앤초비솔트', value: 'taste_saltiness_sea_anchovy_salt' },
        ...
        },
        {
          ...
          label: '브로스',
          children: [
            { id: 1, label: '라이트브로스', value: 'taste_saltiness_broth_light_broth' },
            { id: 2, label: '치킨브로스', value: 'taste_saltiness_broth_chicken_broth' },
            { id: 3, label: '베지터블스톡', value: 'taste_saltiness_broth_vegetable_stock' },
        ...
        },
        {
          ...
          label: '발효계 짠맛',
          children: [
            { id: 1, label: '간장', value: 'taste_saltiness_fermented_salty_soy_sauce' },
            { id: 2, label: '피시소스', value: 'taste_saltiness_fermented_salty_fish_sauce' },
            { id: 3, label: '피클브라인', value: 'taste_saltiness_fermented_salty_pickled_brine' },
            { id: 4, label: '김치브라인', value: 'taste_saltiness_fermented_salty_kimchi_brine' },
            { id: 5, label: '올리브브라인', value: 'taste_saltiness_fermented_salty_olive_brine' },
          ],
        },
        {
          id: 5,
          label: '치즈계',
          children: [
            { id: 1, label: '파르미지아노', value: 'taste_saltiness_cheesy_salty_parmesan' },
            { id: 2, label: '페코리노', value: 'taste_saltiness_cheesy_salty_pecorino' },
            { id: 3, label: '페타', value: 'taste_saltiness_cheesy_salty_feta' },
            { id: 4, label: '에이지드체다', value: 'taste_saltiness_cheesy_salty_aged_cheddar' },
            { id: 5, label: '블루치즈', value: 'taste_saltiness_cheesy_salty_blue_cheese' },
          ],
        },
      ],
    },
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 4, label: '로스트치킨', value: 'taste_umami_meaty_roast_chicken' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 5, label: '가쓰오부시', value: 'taste_umami_fermented_katsuobushi' },
          ],
        },
        {
          id: 4,
        ...
        },
        {
          ...
          label: '에이징',
          children: [
            { id: 1, label: '파르미지아노껍질', value: 'taste_umami_aged_parmesan_rind' },
            { id: 2, label: '에이지드치즈', value: 'taste_umami_aged_aged_cheese' },
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 4, label: '해바라기씨', value: 'taste_toasty_nutty_sunflower_seed' },
        ...
        },
        {
          ...
          label: '맥아·토스트',
          children: [
            { id: 1, label: '라이트토스트', value: 'taste_toasty_malt_toast_light_toast' },
            { id: 2, label: '미디엄토스트', value: 'taste_toasty_malt_toast_medium_toast' },
            { id: 3, label: '다크토스트', value: 'taste_toasty_malt_toast_dark_toast' },
        ...
        },
        {
          ...
          label: '곡물음료',
          children: [
            { id: 1, label: '보리차', value: 'taste_toasty_grain_drink_barley_tea' },
            { id: 2, label: '옥수수수염차', value: 'taste_toasty_grain_drink_corn_silk_tea' },
            { id: 3, label: '현미차', value: 'taste_toasty_grain_drink_brown_rice_tea' },
            { id: 4, label: '미숫가루', value: 'taste_toasty_grain_drink_misugaru' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 2, label: '비스킷', value: 'taste_toasty_doughy_cereal_biscuit' },
            { id: 3, label: '크래커', value: 'taste_toasty_doughy_cereal_cracker' },
            { id: 4, label: '도우', value: 'taste_toasty_doughy_cereal_bread_dough' },
            { id: 5, label: '누룽지', value: 'taste_toasty_doughy_cereal_scorched_rice' },
          ],
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          label: '훈연식품',
          children: [
            { id: 1, label: '훈제베이컨', value: 'taste_smoky_smoked_food_smoked_bacon' },
            { id: 2, label: '훈제치즈', value: 'taste_smoky_smoked_food_smoked_cheese' },
            { id: 3, label: '훈제넛', value: 'taste_smoky_smoked_food_smoked_nut' },
            { id: 4, label: '훈제소금', value: 'taste_smoky_smoked_food_smoked_salt' },
            { id: 5, label: '라프산소총', value: 'taste_smoky_smoked_food_lapsang_souchong' },
          ],
        },
        {
          id: 4,
        ...
        },
        {
          ...
          children: [
            ...
            { id: 2, label: '담배잎', value: 'taste_smoky_tobacco_leather_tobacco_leaf' },
            { id: 3, label: '파이프스모크', value: 'taste_smoky_tobacco_leather_pipe_smoke' },
            { id: 4, label: '가죽', value: 'taste_smoky_tobacco_leather_leather' },
            { id: 5, label: '새들가죽', value: 'taste_smoky_tobacco_leather_saddle_leather' },
          ],
        },
      ],
    },
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 5, label: '블러드오렌지', value: 'acidity_citrus_orange_blood_orange' },
          ],
        },
        {
          id: 3,
          label: '열대과일',
          children: [
            { id: 1, label: '파인애플', value: 'acidity_citrus_tropical_pineapple' },
            { id: 2, label: '패션프루트', value: 'acidity_citrus_tropical_passionfruit' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 4, label: '블랙커런트', value: 'acidity_citrus_berry_blackcurrant' },
      ...
      children: [
        {
          ...
          label: '그린애플',
          children: [
            { id: 1, label: '풋사과', value: 'acidity_malic_green_apple_unripe_apple' },
            { id: 2, label: '사과껍질', value: 'acidity_malic_green_apple_apple_peel' },
            { id: 3, label: '사과즙', value: 'acidity_malic_green_apple_apple_juice' },
            { id: 4, label: '사과식초', value: 'acidity_malic_green_apple_apple_vinegar' },
            { id: 5, label: '사과캔디', value: 'acidity_malic_green_apple_apple_candy' },
          ],
        },
        {
          id: 2,
        ...
        },
        {
          ...
          label: '포도',
          children: [
            { id: 1, label: '화이트그레이프', value: 'acidity_malic_grape_white_grape' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 3, label: '사워체리', value: 'acidity_malic_plum_cherry_sour_cherry' },
            { id: 4, label: '블랙체리', value: 'acidity_malic_plum_cherry_black_cherry' },
            { id: 5, label: '자두껍질', value: 'acidity_malic_plum_cherry_plum_skin' },
          ],
        },
        {
          id: 5,
      ...
      children: [
        {
          ...
          label: '와인',
          children: [
            { id: 1, label: '화이트와인', value: 'acidity_tartaric_wine_white_wine' },
            { id: 2, label: '레드와인', value: 'acidity_tartaric_wine_red_wine' },
            { id: 3, label: '로제와인', value: 'acidity_tartaric_wine_rose_wine' },
            { id: 4, label: '스파클링와인', value: 'acidity_tartaric_wine_sparkling_wine' },
        ...
        },
        {
          ...
          label: '건과일',
          children: [
            { id: 1, label: '건자두', value: 'acidity_tartaric_dried_fruit_prune' },
            { id: 2, label: '건포도', value: 'acidity_tartaric_dried_fruit_raisin' },
            { id: 3, label: '말린살구', value: 'acidity_tartaric_dried_fruit_dried_apricot' },
            { id: 4, label: '말린무화과', value: 'acidity_tartaric_dried_fruit_dried_fig' },
            { id: 5, label: '건체리', value: 'acidity_tartaric_dried_fruit_dried_cherry' },
          ],
        },
        {
          id: 3,
          ...
          children: [
            ...
            { id: 2, label: '포도껍질', value: 'acidity_tartaric_grape_grape_peel' },
            { id: 3, label: '포도씨', value: 'acidity_tartaric_grape_grape_seed' },
            { id: 4, label: '청포도즙', value: 'acidity_tartaric_grape_grape_juice' },
            { id: 5, label: '와인머스트', value: 'acidity_tartaric_grape_wine_must' },
          ],
        },
        {
          id: 4,
          label: '시큼한 과즙',
          children: [
            { id: 1, label: '석류', value: 'acidity_tartaric_tangy_juice_pomegranate' },
            { id: 2, label: '타마린드', value: 'acidity_tartaric_tangy_juice_tamarind' },
            { id: 3, label: '감귤', value: 'acidity_tartaric_tangy_juice_mandarin_orange' },
            { id: 4, label: '포멜로', value: 'acidity_tartaric_tangy_juice_pomelo' },
            { id: 5, label: '사워체리즙', value: 'acidity_tartaric_tangy_juice_sour_cherry_juice' },
          ],
        },
        {
          id: 5,
          ...
          children: [
            ...
            { id: 5, label: '날카로운', value: 'acidity_tartaric_crisp_tart_sharp' },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          label: '발효산미',
          children: [
            { id: 1, label: '식초', value: 'acidity_acetic_fermented_acid_vinegar' },
            { id: 2, label: '사과식초', value: 'acidity_acetic_fermented_acid_apple_vinegar' },
            { id: 3, label: '발사믹식초', value: 'acidity_acetic_fermented_acid_balsamic' },
            { id: 4, label: '포도식초', value: 'acidity_acetic_fermented_acid_grape_vinegar' },
            { id: 5, label: '와인비네거', value: 'acidity_acetic_fermented_acid_wine_vinegar' },
          ],
        },
        {
          id: 2,
          label: '발효음료',
          children: [
            { id: 1, label: '콤부차', value: 'acidity_acetic_fermented_drink_kombucha' },
            { id: 2, label: '사워비어', value: 'acidity_acetic_fermented_drink_sour_beer' },
            { id: 3, label: '사워사케', value: 'acidity_acetic_fermented_drink_sour_sake' },
            { id: 4, label: '요거트드링크', value: 'acidity_acetic_fermented_drink_yogurt_drink' },
            { id: 5, label: '라씨', value: 'acidity_acetic_fermented_drink_lassi' },
          ],
        },
        {
          id: 3,
          label: '피클',
          children: [
            { id: 1, label: '오이피클', value: 'acidity_acetic_pickle_cucumber_pickle' },
            { id: 2, label: '무피클', value: 'acidity_acetic_pickle_radish_pickle' },
            { id: 3, label: '양파피클', value: 'acidity_acetic_pickle_onion_pickle' },
            { id: 4, label: '김치', value: 'acidity_acetic_pickle_kimchi' },
            { id: 5, label: '사워크라우트', value: 'acidity_acetic_pickle_sauerkraut' },
          ],
        },
        {
          id: 4,
          label: '사워도우',
          children: [
            { id: 1, label: '사워도우', value: 'acidity_acetic_sourdough_sourdough' },
            { id: 2, label: '천연효모', value: 'acidity_acetic_sourdough_natural_yeast' },
            { id: 3, label: '발효빵', value: 'acidity_acetic_sourdough_fermented_bread' },
            { id: 4, label: '요거트빵', value: 'acidity_acetic_sourdough_yogurt_bread' },
            { id: 5, label: '루벤빵', value: 'acidity_acetic_sourdough_reuben_bread' },
          ],
        },
        {
          id: 5,
          label: '식초향산미',
          children: [
            { id: 1, label: '신맛강한', value: 'acidity_acetic_vinegar_aroma_sharp_acid' },
            { id: 2, label: '톡쏘는', value: 'acidity_acetic_vinegar_aroma_tingling' },
            { id: 3, label: '자극적인', value: 'acidity_acetic_vinegar_aroma_pungent' },
            { id: 4, label: '매끈한산', value: 'acidity_acetic_vinegar_aroma_smooth_acid' },
            { id: 5, label: '가벼운산', value: 'acidity_acetic_vinegar_aroma_light_acid' },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          label: '유산발효',
          children: [
            { id: 1, label: '요거트', value: 'acidity_lactic_lactic_fermentation_yogurt' },
            { id: 2, label: '사워크림', value: 'acidity_lactic_lactic_fermentation_sour_cream' },
            { id: 3, label: '버터밀크', value: 'acidity_lactic_lactic_fermentation_buttermilk' },
            { id: 4, label: '리코타', value: 'acidity_lactic_lactic_fermentation_ricotta' },
            { id: 5, label: '케피어', value: 'acidity_lactic_lactic_fermentation_kefir' },
          ],
        },
        {
          id: 2,
          label: '치즈',
          children: [
            { id: 1, label: '프레시치즈', value: 'acidity_lactic_cheesy_lactic_fresh_cheese' },
            { id: 2, label: '크림치즈', value: 'acidity_lactic_cheesy_lactic_cream_cheese' },
            { id: 3, label: '요거트치즈', value: 'acidity_lactic_cheesy_lactic_yogurt_cheese' },
            { id: 4, label: '마스카포네', value: 'acidity_lactic_cheesy_lactic_mascarpone' },
            { id: 5, label: '퀘소블랑코', value: 'acidity_lactic_cheesy_lactic_queso_blanco' },
          ],
        },
        {
          id: 3,
          ...
          children: [
            ...
            { id: 2, label: '생크림', value: 'acidity_lactic_buttery_dairy_fresh_cream' },
            { id: 3, label: '우유', value: 'acidity_lactic_buttery_dairy_milk' },
            { id: 4, label: '연유', value: 'acidity_lactic_buttery_dairy_condensed_milk' },
            { id: 5, label: '요구르트', value: 'acidity_lactic_buttery_dairy_yogurt_drink' },
          ],
        },
        {
          id: 4,
        ...
        },
        {
          ...
          label: '요거트',
          children: [
            { id: 1, label: '플레인요거트', value: 'acidity_lactic_yogurty_plain_yogurt' },
            { id: 2, label: '그릭요거트', value: 'acidity_lactic_yogurty_greek_yogurt' },
            { id: 3, label: '딸기요거트', value: 'acidity_lactic_yogurty_strawberry_yogurt' },
            { id: 4, label: '복숭아요거트', value: 'acidity_lactic_yogurty_peach_yogurt' },
            { id: 5, label: '꿀요거트', value: 'acidity_lactic_yogurty_honey_yogurt' },
          ],
        },
      ],
    },
