...
import { FORM_RESULT_MOCK } from '../../../constants/form_result_mock';
...
const local = localStorage.getItem('result');
const RESULT: EvaluationRoot = local ? JSON.parse(local) : FORM_RESULT_MOCK;

const { version, sca_info, evaluation_schemas, total_evaluation } = RESULT;
