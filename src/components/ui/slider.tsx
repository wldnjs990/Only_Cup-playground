...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      ...
      max={max}
      className={cn(
        'relative flex w-full touch-none items-center select-none data-[disabled]:opacity-50 data-[orientation=vertical]:h-full data-[orientation=vertical]:min-h-44 data-[orientation=vertical]:w-[70%] data-[orientation=vertical]:flex-col',
        className,
      )}
      {...props}
    >
